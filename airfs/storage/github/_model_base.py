...
class GithubObject(Mapping):
    ...
    Instances represent headers of an object this a specific spec. Instance is only
    generated by the "head" class-method that acts as a factory.

    Classes also allow navigating in the virtual file-system tree that represents the
    GitHub repositories.
    """
    ...
    #: dict key is key name, dict value is tuple of the key path to follow
    HEAD_EXTRA = ()
    ...
    #: Symlink like the object pointing to the specified absolute path
    SYMLINK = None
    ...
    def __repr__(self):
        ...
        Values that are lazily evaluated and are not yet
    ...
    def _update_key(cls, spec):
        """Update key in spec with the current model.
    ...
    def _raise_if_not_dir(cls, isdir, spec, client=None):
        ...
        Args:
            ...
            spec (dict): Item spec.
            client (airfs.storage.github._api.ApiV3): Client. If present, also check
